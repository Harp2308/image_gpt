...
def reconstruct_all_steps(
    ...
    for step_key, image_ids in grouped.items():
        ...
        out_path = output_dir / f"page_{page_num}_step_{step_key}.png"
...
#     PATH=r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputsv1\results\e1_page_2_result.json"
#     with open(PATH,"r",encoding="utf-8") as f:
#         data=json.load(f)

#     result = group_image_ids_by_step(data["results"])
#     print(result)

#     base_dir = Path(r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputsv1\crops\page_2\crops")
#     output_dir = Path(r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputsv1\test_reconstructed")

#     grouped = group_image_ids_by_step(data["results"])  # data = your loaded JSON
#     status = reconstruct_all_steps(grouped, page_num=4, base_dir=base_dir,
#                                     output_dir=output_dir, reconstruct_fn=reconstruct)
...
#         logger.warning(f"Steps failed: {failed}")
    ...
    # page_path = r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputs\crops\page_4\marked\page_4_marked.png"

    # crop_paths = [
    #     r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputs\crops\page_4\crops\page_4_ca18.png",
    #     r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputs\crops\page_4\crops\page_4_f2d2.png",
    #     r"D:\Harpreet Data\1_PROJECTS\Colep_ai\colepV1\outputs\crops\page_4\crops\page_4_d4af.png"
    # ]
