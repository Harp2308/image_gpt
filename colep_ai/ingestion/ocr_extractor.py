...
credentials_path=r"D:\Harpreet Data\1_PROJECTS\Colep_ai\1\key.json"
...
if __name__ == "__main__":
    client = get_vision_client(credentials_path)  # set once
    image_dir = Path("op_im")

    for img in sorted(image_dir.glob("*.png")):
        image_to_vision_json(str(img), output_dir="output_json", client=client)