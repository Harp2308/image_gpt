 ...
 
{
  ...
  "flowchart": {
    ...
    "flow_chart_description": "<natural language narrative of the complete process from start to end, in Portuguese, 3-6 sentences capturing all branches and loops>",
    "flow_chart_description_en": "<natural language narrative of the complete process from start to end, in English, 3-6 sentences capturing all branches and loops>"
  }
}
